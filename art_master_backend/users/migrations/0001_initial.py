    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'client'), ('master', 'master')], default='client', max_length=9, verbose_name='Статус')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('client', 'master'), name='unique_subscribe'),
        ),
        migrations.AddConstraint(
