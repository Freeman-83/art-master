    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('building', models.CharField(blank=True, max_length=1, null=True, verbose_name='Корпус/Строение')),
                ('office_number', models.IntegerField(blank=True, null=True, verbose_name='Офис')),
            ],
        ),
        migrations.CreateModel(
